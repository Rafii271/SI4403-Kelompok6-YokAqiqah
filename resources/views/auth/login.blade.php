                ...
                <div class="card bg-light bg-opacity-25" style="margin-top:35%;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3">
                                <label for="email" class="textcol col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="password" class="textcol col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="textcol form-check-label" for="remember">
                                            {{ __('Remember Me') }}
                                        </label>
                                    </div>
                                </div>
